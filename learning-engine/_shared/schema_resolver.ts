...
/** Canonical protocol source for SKILL.md to reference when schema drift is detected. */
export const REFRESH_PROTOCOL_SOURCE =
  "/Users/jack/.hermes/skills/_shared/schema-drift-protocol.md";
